...
GO
insert into mu_mpl_order(MU_MPL_SEARCH_ID,FIELD_CODE,FIELD_NAME,ASC_DESC,SORT_NO,ARCHIVE,PLUGIN_NO) values ([~MU_MPL_SEARCH_ID~],'C.MODIFYDATE','修改时间','asc','999','F','P10021')
GO
SET IDENTITY_INSERT mu_mpl_pre_condition OFF 
GO
SET IDENTITY_INSERT mu_mpl_select OFF 
GO
insert into mu_mpl_select(MU_MPL_SEARCH_ID,FIELD_CODE,FIELD_NAME,SORT_NO,ALLOW_COUNT,ARCHIVE,PLUGIN_NO) values ([~MU_MPL_SEARCH_ID~],'C.VB','会员类型',999,'F','F','P10021')
GO
...
GO
insert into mu_mpl_select(MU_MPL_SEARCH_ID,FIELD_CODE,FIELD_NAME,SORT_NO,ALLOW_COUNT,ARCHIVE,PLUGIN_NO) values ([~MU_MPL_SEARCH_ID~],'c.TEAM','组ID',999,'F','F','P10021')
GO
SET IDENTITY_INSERT mova_function OFF 
GO
...
SET IDENTITY_INSERT mu_object OFF 
GO
insert into mu_object(PLUGIN_NO,TABLE_NAME,OBJECT_CODE,OBJECT_NAME,OWNER,IS_SEAT,IS_LOCKED,IS_DISCARD,IS_SYSTEM,IS_PUBLISH,VIEW_COL,ARCHIVE,PRINT_TEMPLATE,IS_RULE,IS_PRIVATE,IS_HIERARCHY,CHK_REPEAT,ALLOW_BATCH,ADD_CONTINUE,SORT_NO,IS_SINGLE,PRE_NEW_JS,PRE_EDIT_JS,END_NEW_JS,END_EDIT_JS,ALL_SHOW_MASTER,SEARCH_SCOPE,NEW_SUBMIT_JS,EDIT_SUBMIT_JS,PUB_JS,SUPPER_MANAGER) values ('P10021','MU_OPP1','M00_K000000042','车辆违章业务','M00','F',' ','F','F','T',2,'F','','F','F','F','','F','T',null,'T','','','','','F','GROUP','return calculate();','hekuan();
heJi();
return limitFive();
','function calculate(){
var returnMark;	          
...
SET IDENTITY_INSERT mu_mpl_condition OFF 
GO
insert into mu_mpl_condition(PLUGIN_NO,MU_MPL_SEARCH_ID,LEFT_BRACKET,FIELD_CODE,FIELD_NAME,CONDITION,MATCHING_VALUE,RIGHT_BRACKET,AND_OR,IS_NUMERIC,SORT_NO,ARCHIVE) values ('P10021',[~MU_MPL_SEARCH_ID~],' ','C.V0','车牌号码','like','粤',' ','',null,999,'F')
GO
SET IDENTITY_INSERT mu_mpl_group OFF 
GO
...
SET IDENTITY_INSERT mu_mpl_select OFF 
GO
insert into mu_mpl_select(MU_MPL_SEARCH_ID,FIELD_CODE,FIELD_NAME,SORT_NO,ALLOW_COUNT,ARCHIVE,PLUGIN_NO) values ([~MU_MPL_SEARCH_ID~],'C.D0','罚款金额_预收',999,'T','F','P10021')
GO
insert into mu_mpl_select(MU_MPL_SEARCH_ID,FIELD_CODE,FIELD_NAME,SORT_NO,ALLOW_COUNT,ARCHIVE,PLUGIN_NO) values ([~MU_MPL_SEARCH_ID~],'C.D1','滞纳金_预收',999,'T','F','P10021')
GO
insert into mu_mpl_select(MU_MPL_SEARCH_ID,FIELD_CODE,FIELD_NAME,SORT_NO,ALLOW_COUNT,ARCHIVE,PLUGIN_NO) values ([~MU_MPL_SEARCH_ID~],'C.D2','交接费用',999,'T','F','P10021')
GO
