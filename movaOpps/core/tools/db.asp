<BR><BR><center><div style="font-size:18px;color:red">本程序由<a href="http://www.cdinf.net" target="_blank">成都分类信息网</a>提供</DIV></center><BR>
...
sub help()
	...
	echo "新增约束：ALTER TABLE [表名] ADD CONSTRAINT 约束名 CHECK ([约束字段] <= '2000-1-1')<br><br>"
	echo "删除约束：ALTER TABLE [表名] DROP CONSTRAINT 约束名<br><br>"
	echo "新增默认值：ALTER TABLE [表名] ADD CONSTRAINT 默认值名 DEFAULT '51WINDOWS.NET' FOR [字段名]<br><br>"
